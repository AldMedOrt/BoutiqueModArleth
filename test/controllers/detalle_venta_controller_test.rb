...
class DetalleVentaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detalle_ventum" do
    assert_difference("DetalleVentum.count") do
      post detalle_venta_url, params: { detalle_ventum: { cantidad: @detalle_ventum.cantidad, precio_total: @detalle_ventum.precio_total } }
    end
  ...
  test "should update detalle_ventum" do
    patch detalle_ventum_url(@detalle_ventum), params: { detalle_ventum: { cantidad: @detalle_ventum.cantidad, precio_total: @detalle_ventum.precio_total } }
