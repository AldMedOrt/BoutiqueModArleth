...
class CategoriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categorium" do
    assert_difference("Categorium.count") do
      post categoria_url, params: { categorium: { descripcion_categoria: @categorium.descripcion_categoria, nombre_categoria: @categorium.nombre_categoria } }
    end
  ...
  test "should update categorium" do
    patch categorium_url(@categorium), params: { categorium: { descripcion_categoria: @categorium.descripcion_categoria, nombre_categoria: @categorium.nombre_categoria } }
