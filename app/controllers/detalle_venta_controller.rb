class DetalleVentaController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @detalle_ventum.save
        format.html { redirect_to detalle_ventum_url(@detalle_ventum), notice: "Detalle ventum was successfully created." }
  ...
  def update
    respond_to do |format|
      if @detalle_ventum.update(detalle_ventum_params)
        format.html { redirect_to detalle_ventum_url(@detalle_ventum), notice: "Detalle ventum was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to detalle_venta_url, notice: "Detalle ventum was successfully destroyed." }
  ...
  private
    ...
    def set_detalle_ventum
      @detalle_ventum = DetalleVentum.find(params[:id])
    end

    # Only allow a list of trusted parameters through.
    def detalle_ventum_params
      params.require(:detalle_ventum).permit(:precio_total, :cantidad)
    end
end
